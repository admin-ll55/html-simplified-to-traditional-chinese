...
a.name = "StranLink";
a.id = "StranLink";
//a.href = "javascript:StranBody();";
//a.title = "點擊以繁體中文方式瀏覽";    //適用於簡體原文
a.title = "点击以简体中文方式浏览";    //適用於繁體原文
i = document.createElement("i");
i.class = "icon translate";
i.style = "margin-left: 10px;";
a.appendChild(i);
//a.append(document.createTextNode("繁體中文"));    //適用於簡體原文
a.append(document.createTextNode("简体中文"));    //適用於繁體原文
a.addEventListener("click",StranBody);
...
var a=1;function StranBody(fobj)
{if(typeof(fobj)=="object"){var obj=fobj.childNodes;}
else
{var tmptxt=StranLink_Obj.innerHTML.toString()
if(false/*tmptxt.indexOf("简")<0*/)
{BodyIsFt=1
...
{href="javascript:;";onclick=new Function("StranBody();return false")}
